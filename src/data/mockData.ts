    ...
    visits: [
      {
        ...
        date: "2026-05-10",
        chiefComplaint: "Routine diabetic & BP health checkup",
        clinicalNotes: "Baseline PHC visit. High blood pressure noted, patient started on Amlodipine 5mg.",
        vitals: {
      ...
      },
      {
        ...
        patientId: "SHK-2026-1001",
        date: "2026-06-18",
        chiefComplaint: "Follow-up visit for BP monitoring",
        clinicalNotes: "Blood pressure shows improvement after 1 month of regular Amlodipine treatment. Weight reduced by 1kg.",
        vitals: {
  ...
  },
  {
    ...
    visits: [
      ...
      },
      {
        ...
        patientId: "SHK-2026-1002",
        date: "2026-07-28",
        chiefComplaint: "Follow-up check after fever resolution",
        clinicalNotes: "Fever fully subsided. Body aches gone. Vitals back to completely normal range.",
        vitals: {
          ...
          spO2: 99,
          weightKg: 52,
          recordedAt: "2026-07-28T09:30:00Z",
        },
